...
public class AdditionalChargeListTest {
    ...
    @Before
    public void Add2Charges() throws Exception {
        for (int i =0; i< 2; i++) {
            this.ChargePost();
        }
    }
    ...
    @Test
    public void checkAdditionalChargeList() throws EcollectAPIException, IOException {

        /**
         * Get customer list using api
         */
        AdditionalChargeList cl = api.charge.getManyCharges(2, 0);
