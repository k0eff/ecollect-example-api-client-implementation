...
public class InvoiceGetSingleTest {
    ...
    public Invoice getInvoice(Invoice invToLookFor) throws EcollectAPIException, IOException {
        return api.invoice.getInvoiceByObj(invToLookFor);
    }



    @Test
    public void InvoiceGetSingleTest() throws Exception {
        Invoice invoice = createInvoice();
        Invoice invoicePosted = postInvoice(invoice);
        Invoice invGotten = getInvoice(invoicePosted);

        Assert.assertTrue(invoice.getCustomer().equals(invGotten.getCustomer()));
    }
}
