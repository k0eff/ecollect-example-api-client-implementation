...
public class ClaimListTest {
    ...
    public void ClaimPost() throws Exception {
    ...
    @Before
    public void post2Charges() throws Exception {
        for (int i=0; i<2; i++) {
            this.ClaimPost();
        }
    }
    ...
    @Test
    public void checkClaimList() throws EcollectAPIException, IOException {

        /**
         * Get customer list using api
         */

        ClaimList cl = api.claim.getManyClaims(2, 0);
