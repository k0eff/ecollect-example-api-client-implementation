...
public class ClaimGetSingleTest {
    ...
    @Test
    public void ClaimGetSingleTest() throws Exception {
        ...
        try {
            ...
            Claim claimGotten = api.claim.getClaimById(claimPosted.getId());
            Assert.assertTrue(claimPosted.getQualityJson().toString().equals(claimGotten.getQualityJson().toString()));
