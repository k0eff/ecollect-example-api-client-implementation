...
public class AdditionalChargeGetSingleTest {
    ...
    @Before
    public void ChargePost() throws Exception {
        ...
        try {
            ...
            this.chargePosted = chargePosted;
    ...
    @Test
    public void ChargeGetSingleTest() throws EcollectAPIException, IOException {
        Assert.assertTrue(this.api.charge.getChargeByObj(this.chargePosted).getCustomer().equals(this.chargePosted.getCustomer()));
    }
